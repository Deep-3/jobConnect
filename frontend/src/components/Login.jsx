...
const handleSocialLogin=googleHandler();
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-8">
      <div className="bg-white p-10 rounded-2xl shadow-lg w-full max-w-[440px]">
        <h2 className="text-2xl text-slate-800 mb-2 text-center">Welcome Back</h2>
  ...
  Forgot Password?
        ...
        <p className="text-center text-sm text-slate-500">
          Don't have an account? <a href="/register" className="text-[#0B877D] font-medium">Sign up</a>
        </p>
      </div>
    </div>
  );
